...
class AuthenticationFormCustom(AuthenticationForm):
    ...
    password = forms.CharField(label="Senha", error_messages={
                               'required': 'Esse campo não deve estar vazio.'}, widget=forms.PasswordInput)
    error_messages = {
...
class NewUserForm(UserCreationForm):
    ...
    password2 = forms.CharField(
        label="Senha Confirmação", widget=forms.PasswordInput)
