    ...
    const onsuccess = (response) => {
        ...
        const getAnimangaSubtypes = (responseSubtype) => {
            ...
            */
            ...
            const kitsuStatus = {
                "TV": animangaStatus[0],
                "OVA": animangaStatus[1],
                "ONA": animangaStatus[2],
                "movie": animangaStatus[3],
                "special": animangaStatus[4],
                "music": animangaStatus[4],
            }
            if(!Object.keys(kitsuStatus).includes(responseSubtype)){
                return animangaStatus[4]
            }
        ...
        setValueById(kitsuResponse.studio, "id_studio")
        setValueById(kitsuResponse.startDate, "id_release_date")
        setValueById(kitsuResponse.episodeCount ? kitsuResponse.episodeCount : 0, "id_total_episodes")
